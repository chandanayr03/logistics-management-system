...
<head>
    ...
    <title>Dashboard | Logistic Management System </title>
...
<div id="content" class="main-content">
                    ...
                    <div class="widget widget-chart-three">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">Shipments Overview</h5>
                            ...
                            <div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p>Total Shipments: <span id="totalShipments"></span></p>
                                        <p>Total Vehicles: <span id="totalVehicles"></span></p>
                                        <p>Most Active Route: <span id="mostActiveRoute"></span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
    <script>
    // Example data for charts and summaries (replace with actual data)
    var shipmentsData = {
        series: [44, 55, 41, 17, 15],
        labels: ['USA', 'Germany', 'UK', 'Japan', 'China']
    };

    var vehiclesData = {
        series: [40, 30, 20, 10],
        labels: ['Truck', 'Van', 'Car', 'Motorcycle']
    };

    // Initialize ApexCharts for shipments chart
    var chartShipments = new ApexCharts(document.querySelector("#chartShipments"), {
        series: shipmentsData.series,
        chart: {
            type: 'donut'
        },
    ...
    // Initialize ApexCharts for vehicles chart
    var chartVehicles = new ApexCharts(document.querySelector("#chartVehicles"), {
        series: vehiclesData.series,
        chart: {
            type: 'pie'
        },
        labels: vehiclesData.labels,
        responsive: [{
            breakpoint: 480,
            options: {
                chart: {
    ...
    document.getElementById('totalShipments').innerText = shipmentsData.series.reduce((a, b) => a + b, 0);
    document.getElementById('totalVehicles').innerText = vehiclesData.series.reduce((a, b) => a + b, 0);
    document.getElementById('mostActiveRoute').innerText = shipmentsData.labels[0]; // Example: Most active route
