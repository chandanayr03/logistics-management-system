   ...
   ?>         
       ...
       { ?>
                        <tr>
                            ...
                            <td>
                        <span class="text-danger"><?php echo $data['license_plate']; ?>
                            </td>

                            <td class="text-center">
                            <span class="text-success"><?php echo $data['status']; ?></span>                            </td>
                            <td class="text-center">
                                <div class="action-btns">
                                    
                                    
                                    <a href="deleteplace.php?id=<?php echo $data['id'];?>" class="action-btn btn-delete bs-tooltip" data-toggle="tooltip" data-placement="top" title="Delete">
