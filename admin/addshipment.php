...
<script>
        // JavaScript function to update the total bill
        function updateTotalBill() {
            ...
            const totalBill = quantity * selectedProductPrice;
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insert_query = "INSERT INTO orders (product_id, quantity, customer_name, phone, total_bill) 
                     VALUES ('$product_id', '$quantity', '$customer_name', '$phone', '$total_bill')";
...
<!--  END SIDEBAR  -->
        ...
        <div class="form-group mb-4">
            ...
            <select class="form-control" id="product" name="product_id" required onchange="updateTotalBill()">
        ...
        <div class="form-group mb-4">
            ...
            <input type="number" class="form-control" id="quantity" name="quantity" required oninput="updateTotalBill()">
        </div>
        <div class="form-group mb-4">
        ...
        <div class="form-group mb-4">
            ...
            <input type="number" step="0.01" class="form-control" id="total_bill" name="total_bill" readonly>
        </div>
